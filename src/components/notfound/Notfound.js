            ...
            <div className="c col-lg-7 col-12">
              <div className="text mb-lg-0 mb-5 text-lg-start text-center">
                ...
                <p className="text-desc text-capitalize mb-lg-3 mb-5 text-muted">
                  this page which you are trying to reach is not found. if you
                  are having any issues feel free to send us your problem, and
                  we will be happy to fix it as soon as we can
                </p>
                <Link
