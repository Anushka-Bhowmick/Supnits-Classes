						...
						<div className = 'c col-lg-6 col-12'>
							<div className = 'right-side text-lg-start text-center'>
								...
								<p className = 'text text-capitalize mb-4'>
									<span className = 'sub-word'>Supnits Classes</span> offers new courses and lessons weekly in all fields, if you are interested then you might desire to register via your email in order to get our offers directly in your inbox
								</p>
								<div className = 'row'>
